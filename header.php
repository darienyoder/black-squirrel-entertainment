...
<html id="bse-html" lang="en-US" <?php /*language_attributes();*/ ?> <?php /*blankslate_schema_type();*/ ?>>
    <head>
        ...
        <?php echo '<link rel="stylesheet" href="/wp-content/themes/BlackSquirrelEntertainment/style/master.css?ver='.$_SERVER['REQUEST_TIME'].'">'; ?>
    ...
    <body id="bse-body" onload="if(window.location.href.endsWith('/')&&window.location.pathname!='/'){window.location.href=window.location.href.slice(0,window.location.href.length-1);}else{setInterval(updateStyle, 1);setupLinkDetection();}" <?php /*body_class();*/ ?>>
        ...
        <!-- <div style="position:absolute; top:0px; left:0px; right:0px; min-height:100vh;"> -->
            <main>
